...
table_df = emissions[["name","2000","2022"]]
...
emissions_long = emissions.melt(id_vars=["name","geo"], var_name="year", value_name="emissions")
...
emissions_long_1990_2022 = emissions_long.query("year <= 2022 & year >= 1990")

# Query for 5 countries using the `name` column (adjust these to any countries you like)

emissions_long_subset = emissions_long_1990_2022.query("name.isin(['UAE','Brazil','Bolivia','Bahrain','Belgium'])")

# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by name.
fig_chart = px.line(emissions_long_subset, x = "year", y = "emissions", color="name")
fig_chart
